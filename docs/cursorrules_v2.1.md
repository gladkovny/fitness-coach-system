...
## 📝 CONTEXT7 MCP (будущее)

После стабилизации системы добавить Context7 для актуальной документации:

```json
// .cursor/mcp.json (когда будем внедрять)
{
  "mcpServers": {
    "context7": {
      "command": "npx",
...
**Когда внедрять:** После того как:
1. ✅ Supabase стабильно работает
2. ✅ Трекер переведён на Supabase
