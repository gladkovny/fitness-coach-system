...
>
> **⚠️ Устаревший таймлайн:** секции «Фаза 1–6» с датами Feb–Dec 2026 не соответствуют текущему фокусу (MVP Telegram Mini App). Документ полезен как видение продукта и целевой стек; операционные сроки — см. ROADMAP_MVP_MINI_APP и STATUS_ALL_PROJECTS в репо Telegram_Mini_App.
